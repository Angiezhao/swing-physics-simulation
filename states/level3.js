...
Level3.prototype = {
  ...
  create:function(){
    ...
    this.game.physics.box2d.restitution = 0.1;
    ...
    var star = this.game.add.sprite(900, 330,'star');
    ...
    var stara = this.game.add.sprite(260, 200,'star');
    ...
    var starb = this.game.add.sprite(1000, 130,'star');
    this.game.physics.box2d.enable(starb);
    starb.body.kinematic = true;
    starb.body.restitution = 0.02;

    starb.body.setBodyContactCallback(rope.body, this.killStar,this);
